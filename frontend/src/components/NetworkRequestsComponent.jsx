...
import { MdFilterAlt,MdLaptop, MdOutlineFileDownload, MdOutlineFileUpload, MdOutlineWifiPassword } from 'react-icons/md';
...
const Accordion = styled((props) => (
  ...
  backgroundColor: theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, .05)' : 'rgba(0, 0, 0, .03)', // Default background color
...
const AccordionSummary = styled((props) => (
  <MuiAccordionSummary
    expandIcon={<ArrowForwardIosSharpIcon  sx={{ fontSize: '0.9rem',color:'white', transform: 'rotate(-90deg)' }} />}
    {...props}
  />
))(({ theme }) => ({
  backgroundColor:
...
function NetworkRequestsComponent() {
  ...
  <IoMdSearch />
  <span style={{ margin: "0 8px" }}>|</span>
  <span style={{margin:"0 8px", display:"flex", alignItems:"center"}}><IoIosCheckbox color="lightblue"/> &nbsp; <span>Preserve log</span><span style={{margin:"0 8px"}}>|</span></span>
  <span style={{margin:"0 8px", display:"flex", alignItems:"center"}}><FaRegSquare /> &nbsp; <span>Disable cache</span><span style={{margin:"0 8px"}}>No throttling</span><span style={{margin:"0 8px"}}><FaCaretDown /></span><span style={{margin:"0 8px"}}><MdOutlineWifiPassword /></span><span style={{margin:"0 8px"}}>|</span>
  <span style={{margin:"0 8px"}}><MdOutlineFileUpload size={20}/></span>
  <span style={{margin:"0 8px"}}><MdOutlineFileDownload size={20}/></span></span>
        ...
        <div className='input'>
          ...
          <div><span style={{margin:"0 8px", display:"flex", alignItems:"center"}}><FaRegSquare /> &nbsp; <span>3rd-party requests</span></span>
          </div>
        </div>
      </div>
      <div className='main'>
       ...
       <div className='model-main'>
         <div className="modal">
          <div className="modal-content">
            ...
            <Accordion 
            >
              <AccordionSummary aria-controls="general-info-content" id="general-info-header">
            ...
            {/* Request Headers */}
            <Accordion>
              <AccordionSummary aria-controls="request-headers-content" id="request-headers-header">
            ...
            {/* Response Headers */}
            <Accordion>
              <AccordionSummary aria-controls="response-headers-content" id="response-headers-header">
